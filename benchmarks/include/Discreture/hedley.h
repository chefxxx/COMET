...
#define HEDLEY_ARM_VERSION                                              \
    HEDLEY_VERSION_ENCODE(                                              \
        __ARMCC_VERSION / 1000000, (__ARMCC_VERSION % 1000000) / 10000, \
...
#define HEDLEY_TI_VERSION                                                              \
    HEDLEY_VERSION_ENCODE(                                                             \
        __TI_COMPILER_VERSION__ / 1000000, (__TI_COMPILER_VERSION__ % 1000000) / 1000, \
...
#define HEDLEY_COMPCERT_VERSION                                           \
    HEDLEY_VERSION_ENCODE(                                                \
        __COMPCERT_VERSION__ / 10000, (__COMPCERT_VERSION__ / 100) % 100, \
