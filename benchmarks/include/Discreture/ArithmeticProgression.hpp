...
class ArithmeticProgression
{
    ...
    ///
    ////////////////////////////////////////////////////////////
    explicit ArithmeticProgression(IntType n) : from_(0), to_(n), step_(1) { assert(n >= 0); }
    ...
    class iterator : public boost::iterator_facade<
                         iterator, const IntType&, boost::random_access_traversal_tag>
    {
        public:
        explicit iterator(size_type t_from = 0, size_type t_step = 1) : m_ID(t_from), step_(t_step)
        {
        }
